...
val_list = CON_DATA_PATH + '/ASVspoof5/ASVspoof5_eval/ASVspoof5_eval.lst'  
...
trn_input_dirs = [CON_DATA_PATH + '/ASVspoof5/ASVspoof5_eval/flac_T/']
val_input_dirs = [CON_DATA_PATH + '/ASVspoof5/ASVspoof5_eval/flac_E/']
...
set_type='ASVspoof5_eval'  # 'ASVspoof5_dev' or 'ASVspoof5_eval'
...
test_input_dirs = [test_input_path + '/flac_E/']
